...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // inputs
        inputFrom = (Spinner) findViewById(R.id.inputFrom);
        inputTo = (Spinner) findViewById(R.id.inputTo);
...
//        convertMoney();
    ...
    View.OnClickListener myHandler1 = new View.OnClickListener() {
        public void onClick(View v) {
              ...
              String valueFrom = inputFrom.getSelectedItem().toString();
              String valueTo = inputTo.getSelectedItem().toString();




            if (valueFrom.isEmpty() && valueTo.isEmpty() && inputAmount.getText().toString().isEmpty()) {
            ...
            postData(parseDouble(inputAmount.getText().toString()), valueFrom,valueTo);
